...
describe('date utils', () => {
  test('prefers global start/end when present', () => {
    const event = { globalStart: '2025-10-10', globalEnd: '2025-10-20', cnStart: '2025-04-10', cnEnd: '2025-04-20' }
  ...
  test('estimates cn dates by +6 months when global missing', () => {
    const event = { globalStart: null, globalEnd: null, cnStart: '2025-04-10', cnEnd: '2025-04-20' }
