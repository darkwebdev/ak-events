...
import type { DailySetting, Settings } from '../../types.js';
import './index.css';

interface DailyOrundumProps {
  settings: Settings;
  updateSetting: (key: string, property: keyof DailySetting, value: boolean | number) => void;
  setAllSettingsEnabled: (enabled: boolean) => void;
  settingsTotal: number;
}

export function DailyOrundum({
  settings,
  updateSetting,
      ...
      <div className="ak-aside-list">
        ...
        <div className="ak-aside-item">
          <label className="ak-aside-label">
            ...
            <span className="ak-aside-value">
              <Orundum>{(settings.Annihilation.weeklyOrundum ?? 0) / 7}</Orundum>
            </span>
          </label>
        </div>
        <div className="ak-aside-item">
          <label className="ak-aside-label">
            ...
            <span className="ak-aside-value">
              <Orundum>
                {(settings['New Annihilation'].biMonthlyOrundum ?? 0) / 60 +
                  (settings['New Annihilation'].weeklyOrundum ?? 0) / 7}
              </Orundum>
            </span>
          </label>
        </div>
        ...
        <div className="ak-aside-item">
          <label className="ak-aside-label">
            ...
            <span className="ak-aside-value">
              <Orundum>{(settings.Missions.weeklyOrundum ?? 0) / 7}</Orundum>
            </span>
          </label>
        </div>
        ...
        <div className="ak-aside-item">
          <label className="ak-aside-label">
            ...
            <span className="ak-aside-value">
              <Orundum>
                {(settings['Green Cert T1'].monthlyOrundum ?? 0) / 30 +
        ...
        <div className="ak-aside-item">
          <label className="ak-aside-label">
            ...
            <span className="ak-aside-value">
              <Orundum>
                {(settings['Monthly Card'].dailyOrundum ?? 0) +
